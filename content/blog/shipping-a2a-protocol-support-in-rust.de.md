---
title: "A2A-Protokollunterstützung in Rust ausliefern: 7 Fallen, vor denen dich niemand warnt"
date: 2026-03-25
...
---
Das [A2A (Agent-to-Agent) Protokoll](https://github.com/google/A2A) ist Googles offener Standard für die Interoperabilität von Agenten: Entdeckung, Aufgaben-Delegierung, Lifecycle-Management über HTTP/JSON‑RPC. Es sitzt neben MCP so, wie TCP neben USB liegt: das eine verbindet Agenten mit Agenten, das andere verbindet Agenten mit Werkzeugen.

Ich habe kürzlich [PR #4166](https://github.com/5queezer/hrafn/pull/4166) veröffentlicht, der native A2A‑Unterstützung zu Hrafn hinzufügt. Das bedeutet sowohl einen eingehenden JSON‑RPC 2.0‑Server als auch ein ausgehendes Client‑Tool, geschrieben in Rust. Der PR bestand 40 Tests und wurde End‑zu‑End‑über fünf Raspberry Pi Zero 2 W Instanzen ausgeführt. Auf dem Weg dorthin bin ich an jede scharfe Kante gestoßen, die im Spec nicht erwähnt wird.

**Der A2A‑Spec ist auf dem Papier sauber. Die Sicherheitsspitzen werden dich in der Produktion erwischen.**

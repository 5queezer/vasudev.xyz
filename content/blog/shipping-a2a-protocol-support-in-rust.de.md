---
title: "Versand der A2A Protocol Support in Rust: 7 Fallstricke, über die niemand Sie warnt"
date: 2026-03-25
description: "Wasich gelernt habe beim Hinzufügen von Agent-to-Agent-Protokollunterstützung zu einem Open-Source-Agenten-Framework."
showcase: true
images: ["/images/shipping-a2a-protocol-support-in-rust-og.png"]
author: "Christian Pojoni"
tags: ["rust", "a2a", "security"]
agentQuestions:
  - "Was sind die Tücken des A2A-Protokolls in Rust?"
  - "Wie sollte A2A-Authentifizierung und -Sicherheit funktionieren?"
  - "Was ist während der Protokollintegration kaputt gegangen?"
series: ["Field Notes"]
translationHash: "e1f9c72874fa7faf8275af1bdaa21038"
chunkHashes: "63693977f4c62ac9,7d3e0b3378417e09,aa7513a6486f8faf,a825fb9bc8a4bae3,5dea57e52b8e70d4,28ed198a8cd428fc,685d9c5b09d7dcf3,6eadb412a20580a0,7262b64366b7ff90,e9307644648922c1"
---

Die [A2A (Agent-to-Agent)‑Protokoll](https://github.com/google/A2A) ist Googles offener Standard für die Interoperabilität von Agenten: Discovery, Aufgaben‑Delegierung, Lebenszyklus‑Management über HTTP/JSON‑RPC. Es steht neben MCP so, wie TCP neben USB steht: das eine verbindet Agenten mit Agenten, das andere verbindet Agenten mit Werkzeugen.

Ich habe kürzlich [PR #4166](https://github.com/5queezer/hrafn/pull/4166) veröffentlicht, der native A2A‑Unterstützung zu Hrafn hinzufügt. Das bedeutet sowohl einen eingehenden JSON‑RPC 2.0‑Server als auch ein ausgehendes Client‑Tool, geschrieben in Rust. Der PR bestand 40 Tests und wurde E2E über fünf Raspberry Pi Zero 2 W‑Instanzen ausgeführt. Auf dem Weg dorthin stieß ich auf jede scharfe Kante, die das Spec nicht erwähnt.

**Das A2A‑Spec ist auf dem Papier sauber. Die Sicherheitsschranken werden dich in der Produktion erwischen.**

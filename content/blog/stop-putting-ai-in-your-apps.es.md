...
date: 2026-03-27
description: "Por qué las funciones de IA dentro de aplicaciones tradicionales son contraproducentes, y cómo MCP invierte la arquitectura."
author: "Christian Pojoni"
tags: ["mcp", "ai", "architecture"]
agentQuestions:
  - "¿Por qué poner aplicaciones en IA en lugar de IA en aplicaciones?"
  - "¿Cómo invierte la arquitectura de la aplicación MCP?"
  - "¿Qué hay de malo en los cuadros de chat de IA integrados?"
series: ["Field Notes"]

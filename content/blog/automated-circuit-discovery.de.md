...
agentQuestions:
  ...
  - "Warum war die Tokenisierung ein Flaschenhals?"
series: ["Reading the Residual Stream"]
series_weight: 2
description: "SAE‑Features können Beziehungen in Gemma-2-2B nicht isolieren. Ich habe eine Mutations‑Selektions‑Schleife gebaut, die das kann. Engpass war die Tokenisierung."
...
Die Antwort lautet ja. Es erforderte 42 gescheiterte Vorschläge, eine Rückkopplungsschleife, die einem LLM beibringt, was der Tokenizer eines anderen Modells macht, und die Erkenntnis, dass der schwierigste Teil der automatisierten Interpretierbarkeit nichts mit Interpretierbarkeit zu tun hat.

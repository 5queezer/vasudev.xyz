---
title: "Stoppen Sie, Entscheidungen in CLAUDE.md zu platzieren. Platzieren Sie sie dort, wo der Agent sie nicht immer liest."
date: 2026-04-19
tags: ["adr", "agents", "architecture", "claude"]
agentQuestions:
  - "Was gehört in den Push‑Kontext versus den Pull‑Kontext?"
  - "Warum ist CLAUDE.md der falsche Ort für Entscheidungen?"
  - "Wie sollten Agenten stattdessen ADRs abrufen?"
description: "Zwei Studien aus 2026 stimmen nicht überein, ob AGENTS.md Coding‑Agents unterstützt. Der Streit ergibt Sinn, sobald man den Push‑Kontext vom Pull‑Kontext trennt."
...
---
Zwei rigorose Studien aus dem Jahr 2026 untersuchten, ob Kontextdateien für Agenten KI‑Coding‑Agenten helfen. Sie kamen zu gegensätzlichen Schlussfolgerungen. Die ETH‑Zürich‑Gruppe führte SWE‑bench Lite und AGENTbench über mehrere Modelle hinweg durch und **stellte fest, dass von LLMs generierte AGENTS.md‑Dateien den Aufgabenerfolg um 3 % reduzierten und die Inferenzkosten um 20 % erhöhten** (https://arxiv.org/abs/2602.11988). Von Entwicklern geschriebene Dateien brachten einen marginalen Anstieg von 4 % bei denselben Kosteneinbußen. Einen Monat früher **meldete Lulla et al. das Gegenteil** (https://arxiv.org/abs/2601.20404) in einem sauberen, gepaarten Experiment mit 124 realen GitHub‑PRs: Das Vorhandensein von AGENTS.md verkürzte die mittlere Laufzeit um 28,64 % und die Ausgabetoken um 16,58 %.

Beide Studien sind sorgfältig. Beide haben reale Messgrößen verwendet. Das Feld spaltete sich sofort in Lager.
...
**Entscheidungen gehören in den Pull‑Kontext, nicht in den Push‑Kontext. Das Vermischen der beiden ist der Grund, warum die Hälfte deines CLAUDE.md dich wahrscheinlich gerade jetzt behindert.**

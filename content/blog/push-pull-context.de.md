---
title: "Höre auf, Entscheidungen in CLAUDE.md zu platzieren. Platziere sie dort, wo der Agent sie nicht immer liest."
date: 2026-04-19
...
description: "Zwei Studien aus dem Jahr 2026 widersprechen sich darüber, ob AGENTS.md Coding‑Agenten hilft. Der Streit wird verständlich, sobald man den Push‑Kontext vom Pull‑Kontext trennt."
...
---
Zwei rigorose Studien aus dem Jahr 2026 untersuchten, ob Kontextdateien für Agenten KI‑Coding‑Agenten helfen. Sie kamen zu gegensätzlichen Schlussfolgerungen. Die ETH‑Zürich‑Gruppe führte SWE‑bench Lite und AGENTbench über mehrere Modelle hinweg durch und [befand, dass von LLM‑generierte AGENTS.md‑Dateien die Aufgabenerfolgsrate um 3 % senkten und die Inferenzkosten um 20 % erhöhten](https://arxiv.org/abs/2602.11988). Von Entwicklern geschriebene Dateien brachten einen marginalen Zuwachs von 4 % bei denselben Kostenerhöhungen. Einen Monat zuvor berichtete [Lulla et al. das Gegenteil](https://arxiv.org/abs/2601.20404) in einem sauberen, gepaarten Experiment mit 124 echten GitHub‑PRs: Die Anwesenheit von AGENTS.md reduzierte die mittlere Laufzeit um 28,64 % und die Ausgabetoken um 16,58 %.

Beide Studien sind sorgfältig. Beide maßen reale Dinge. Das Feld spaltete sich sofort in Lager.

Die Spaltung ist vermeidbar. Beide Studien maß dasselbe Artefakt und behandelten es als ein einziges. Das ist es nicht.

**Entscheidungen gehören in den Pull‑Kontext, nicht in den Push‑Kontext. Das Vermischen der beiden ist der Grund, warum die Hälfte Ihres CLAUDE.md Sie gerade wahrscheinlich behindert.**

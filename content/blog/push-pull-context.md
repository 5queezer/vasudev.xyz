...
**`docs/adr/` (pull).** Binding architectural decisions. One decision per file. Nygard format. This is where "we chose Nautilus over vectorbt because..." lives.

---
title: "Lanzamiento del Soporte del Protocolo A2A en Rust: 7 Trampas que Nadie Te Advierte"
date: 2026-03-25
description: "Lo que aprendí al agregar soporte del protocolo Agent-to-Agent a un marco de trabajo de agentes de código abierto."
...
---
El [protocolo A2A (Agent-to-Agent)](https://github.com/google/A2A) es el estándar abierto de Google para la interoperabilidad entre agentes: descubrimiento, delegación de tareas, gestión del ciclo de vida a través de HTTP/JSON-RPC. Se sitúa junto a MCP de la misma manera que TCP está junto a USB: uno conecta agentes con agentes, el otro conecta agentes con herramientas.
...
**La especificación de A2A es clara en papel. Los problemas de seguridad te atraparán en producción.**

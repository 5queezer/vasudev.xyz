...
---
La mayoría de la investigación sobre memoria en LLM vive en un bucle cómodo: proponer arquitectura, probar en un benchmark personalizado, afirmar una mejora, y seguir adelante. Si realmente estás construyendo memoria para agentes, decidiendo qué almacenar, qué olvidar y cuándo consolidar, la relación señal‑ruido en la literatura es brutal.

Mantengo el [Dream Engine](https://github.com/scrypster/muninndb), una canalización de consolidación inspirada en el sueño para [MuninnDB](https://muninndb.com). Ejecuta la decaimiento de Ebbinghaus, asociación hebbiana, fusión de duplicados cercanos y inferencia transitiva en la memoria del agente entre sesiones. Mi estudio de ablación mostró que **ejecutar todas las fases de consolidación simultáneamente tiene un efecto neto negativo**, muy parecido a la proteína mutante daDREAM que potencia la potenciación a largo plazo pero perjudica el aprendizaje real. La selectividad de fase importa más que la cantidad de fases.

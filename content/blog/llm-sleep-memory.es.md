...
Cada artículo de revisión en este espacio cita inspiración biológica. Ebbinghaus, aprendizaje hebbiano, consolidación sináptica, husos de sueño: el vocabulario está en todas partes. La validación empírica es casi nula. SleepGate y MemoryBench son excepciones porque se comprometen con afirmaciones verificables. Las revisiones se ciñen a taxonomías.

Si estás construyendo memoria para agentes: primero el benchmark, segundo la consolidación, tercero la publicación. Si tu función de consolidación mejora una métrica proxy sin mejorar la precisión de recuperación, has creado un [proxy desconectado](/blog/memory-metrics-lying-how-to-ground-them/), no una función.
...
*Christian Pojoni construye infraestructura de agentes de IA desde el edge. [Hrafn](https://github.com/5queezer/hrafn) es el runtime. [MuninnDB](https://muninndb.com) es la memoria. Más en [vasudev.xyz](https://vasudev.xyz).*

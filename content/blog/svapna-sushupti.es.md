...
series_weight: 5
description: "Neurociencia, artículos recientes de IA y un antiguo texto sánscrito convergen en la misma idea sobre la consolidación offline, pero discrepan sobre qué fase del sueño es la más importante."
...
Pasé una semana leyendo tres cuerpos de literatura que casi nunca se citan entre sí: artículos recientes sobre memoria en IA, neurociencia del sueño y el [Mandukya Upanishad](https://en.wikipedia.org/wiki/Mandukya_Upanishad). Convergen en la misma idea central sobre la consolidación offline. También ponen de relieve un desacuerdo que resulta ser la cuestión de diseño más importante en los sistemas de memoria de IA en la actualidad.

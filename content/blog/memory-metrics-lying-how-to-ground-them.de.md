---
title: "Die Speicherkennzahlen Ihres Agenten lügen Sie an. So stellen Sie sie korrekt ein."
date: 2026-04-02
tags: ["ai", "memory", "benchmarks", "muninndb"]
agentQuestions:
  - "Warum lügen Speichermetriken?"
  - "Welche ground-truth Retrieval-Checks sind wichtig?"
  - "Wie wirkt sich Goodharts Gesetz auf das Gedächtnis von Agenten aus?"
series: ["Building Agents That Sleep"]
series_weight: 3
description: "Die Konsolidierung von Gedächtnisinhalten sieht auf Dashboards großartig aus. Aber wenn Ihre Metriken sich verbessern können, ohne dass die Abrufleistung besser wird, optimieren Sie eine losgelöste Stellvertreter‑Metrik."
...
---
Ich habe ein System zur Gedächtniskonsolidierung für KI‑Agenten gebaut. Es dedupliziert Erinnerungen, stärkt Assoziationen, lässt veraltete Einträge verfallen und erstellt ein Traumtagebuch, das man tatsächlich lesen kann. Das Dashboard sieht fantastisch aus: Dedup‑Rate steigt, Gedächtniszähler sinkt, Assoziationsdichte klettert.

Nichts davon sagt dir, ob der Agent zur richtigen Zeit das Richtige erinnert.

**Wenn sich eine Kennzahl verbessern lässt, ohne dass sich die Abruf‑Qualität ebenfalls verbessert, ist diese Kennzahl ein losgelöster Stellvertreter. Hör auf, sie zu optimieren.**

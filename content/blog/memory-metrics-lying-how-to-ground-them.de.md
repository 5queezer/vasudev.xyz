---
title: "Die Speicherkennzahlen Ihres Agenten täuschen Sie. So können Sie sie verankern."
date: 2026-04-02
tags: ["ai", "memory", "benchmarks", "muninndb"]
agentQuestions:
  - "Warum lügen Speicherkennzahlen?"
  - "Welche Ground-Truth‑Retrieval‑Checks sind relevant?"
  - "Wie wirkt sich Goodharts Gesetz auf das Gedächtnis von Agenten aus?"
series: ["Building Agents That Sleep"]
series_weight: 3
description: "Gedächtniskonsolidierung sieht in Dashboards großartig aus. Aber wenn sich Ihre Metriken verbessern können, ohne dass der Abruf besser wird, optimieren Sie einen abgekoppelten Proxy."
...
---
Ich habe ein System zur Gedächtniskonsolidierung für KI‑Agenten gebaut. Es dedupliziert Erinnerungen, stärkt Assoziationen, lässt veraltete Einträge verfallen und erzeugt ein Traumtagebuch, das man tatsächlich lesen kann. Das Dashboard sieht fantastisch aus: Deduplizierungsrate steigt, Gedächtniszählung sinkt, Assoziationsdichte steigt.

Keines davon sagt Ihnen, ob der Agent das Richtige zur richtigen Zeit erinnert.

**Wenn sich eine Metrik verbessern kann, ohne dass sich die Abrufqualität ebenfalls verbessert, ist diese Metrik ein losgelöster Proxy. Hören Sie auf, sie zu optimieren.**

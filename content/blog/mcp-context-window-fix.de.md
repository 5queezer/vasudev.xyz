...
agentQuestions:
  ...
  - "Wie behebt das verzögerte Laden von Werkzeugen das MCP?"
...
---
Connect [GitHub's MCP server](https://github.com/github/github-mcp-server) to Claude. Jetzt prüfen Sie Ihren Token‑Zähler, bevor Sie eine einzige Nachricht senden. [46.000 Tokens, 22 % von Claude Opus' Kontextfenster](https://www.candede.com/articles/claude-tool-search) werden durch Tool‑Definitionen verbraucht, die Sie noch nicht verwendet haben. Fügen Sie Jira (weiter ~17 K), einen Slack‑Server, Google Drive hinzu, und Sie schieben über 100 K Tokens an Overhead, bevor irgendeine eigentliche Arbeit beginnt. [Anthropic hat interne Setups benchmarkt, die allein bei Tool‑Definitionen 134 K Tokens erreichen](https://www.anthropic.com/engineering/advanced-tool-use).

**Jedes MCP‑Tool, das Sie verbinden, ist eine im Voraus zu zahlende Steuer, egal ob das Tool verwendet wird oder nicht.**

Dies ist das Standardverhalten von MCP‑Clients heute: alle Tool‑Definitionen zu Beginn jeder Anfrage in den Kontext laden. Die Spezifikation verlangt das nicht. Es ist nur der Weg des geringsten Widerstands und skaliert schlecht.
## Warum das passiert

...
description: "Jedes MCP‑Tool, das Sie verbinden, lädt sein vollständiges Schema im Voraus, bevor Sie ein Wort tippen. Das verzögerte Laden von Anthropic behebt das."
images: ["/images/mcp-context-window-fix-og.png"]
images: ["/images/mcp-context-window-fix-og.png"]
translationHash: "277a84ced211157176fce2f8675decc7"
chunkHashes: "22824a098cbd9691,e81dbeffd9a9b444,f42e5e8b8b603887,cfd893eb1abea6bb,27081f359030c72d,665a133456bb0746,324b5b78d6fa7aff"
---
Connect [GitHub's MCP server](https://github.com/github/github-mcp-server) to Claude. Jetzt prüfe deinen Token‑Zähler, bevor du eine einzige Nachricht sendest. [46.000 Token, 22 % von Claude Opus' Kontextfenster](https://www.candede.com/articles/claude-tool-search) werden bereits durch Werkzeugdefinitionen verbraucht, die du noch nicht benutzt hast. Ergänze Jira (weitere ~17 K), einen Slack‑Server, Google Drive, und du schiebst über 100 K Token Overhead, bevor irgendeine eigentliche Arbeit beginnt. [Anthropic hat interne Setups gemessen, die allein bei Werkzeugdefinitionen 134 K Token erreichen](https://www.anthropic.com/engineering/advanced-tool-use).

**Jedes MCP‑Werkzeug, das du anschließt, ist eine im Voraus gezahlte Steuer, egal ob das Werkzeug genutzt wird oder nicht.**

Dies ist das Standardverhalten von MCP‑Clients heute: Alle Werkzeugdefinitionen werden zu Beginn jeder Anfrage in den Kontext geladen. Das Spec verlangt das nicht. Es ist einfach der Weg des geringsten Widerstands und skaliert schlecht.
## Warum das passiert
